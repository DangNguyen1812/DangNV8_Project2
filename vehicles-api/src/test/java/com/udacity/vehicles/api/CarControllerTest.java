...
public class CarControllerTest {
    ...
    private Car getUpdateCar() {
        Car car = new Car();
        car.setLocation(new Location(12.345678, -21.876543));
        Details details = new Details();
        Manufacturer manufacturer = new Manufacturer(100, "Dacia");
        details.setManufacturer(manufacturer);
        details.setModel("Sander");
        details.setMileage(123456);
        details.setExternalColor("blue");
        details.setBody("duster");
        details.setEngine("05.1L V6");
